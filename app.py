...
def apply_space_ui():
    st.markdown("""
        ...
        .desktop-icon {
            ...
            justify-content: flex-end; transition: 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275);
            box-shadow: 0 20px 50px rgba(0,0,0,0.8);
            position: relative; overflow: hidden;
        }
        .desktop-icon:hover { transform: scale(1.05) translateY(-10px); border-color: #00f2ff; box-shadow: 0 0 60px rgba(0, 242, 255, 0.5); }
        .icon-label {
